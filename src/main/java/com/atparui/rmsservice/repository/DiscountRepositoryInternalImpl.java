...
/**
 * Spring Data R2DBC custom repository implementation for the Discount entity.
 */
@SuppressWarnings("unused")
class DiscountRepositoryInternalImpl extends SimpleR2dbcRepository<Discount, UUID> implements DiscountRepositoryInternal {
    ...
    @Override
    public Mono<Discount> findById(UUID id) {
