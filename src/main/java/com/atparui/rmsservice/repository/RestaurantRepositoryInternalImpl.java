...
class RestaurantRepositoryInternalImpl extends SimpleR2dbcRepository<Restaurant, UUID> implements RestaurantRepositoryInternal {
    ...
    @Override
    public Mono<Restaurant> findById(UUID id) {
