...
public class TableWaiterAssignmentSqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("table_assignment_id", table, columnPrefix + "_table_assignment_id"));
        columns.add(Column.aliased("waiter_id", table, columnPrefix + "_waiter_id"));
        return columns;
    }
}
