...
/**
 * REST controller for managing {@link com.atparui.rmsservice.domain.OrderItem}.
 */
@RestController
...
public class OrderItemResource {
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<OrderItemDTO>> getOrderItem(@PathVariable("id") UUID id) {
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteOrderItem(@PathVariable("id") UUID id) {
